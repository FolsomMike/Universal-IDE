...
//
// Using this constructor will default to file format "UTF-16LE" to maintain
...
//force file format when this constructor is used
fileFormat = "UTF-16LE";
...
// IniFile::IniFile (constructor)
//
// Using this constructor will override the default file format "UTF-16LE"
// with pFileFormat.
//
...
private void init(String pFilename) throws IOException
{
...
try{
    ...
    while ((line = in.readLine()) != null) buffer.add(line);
...
String section = "[" + pSection.toLowerCase() + "]";
...
for (i = buffer.listIterator(); i.hasNext(); ) {
    ...
    if ( (matchIndex =
                     ((String)i.next()).toLowerCase().indexOf(section)) == 0) {
